...
objects=[300,220,120,50] #person:70, cars:220, motorcycle:120, dogs:50
...
while 1:
    ...
    cv2.imwrite(current_dir+'/temp-img/test.jpg',frame) 
    distance=100000
    distancemem=100000
    labelmem=""
    labelmod=""
    ...
    dataloader = DataLoader(
        ImageFolder(current_dir+"/temp-img", img_size=416),
        batch_size=1,
        shuffle=False,
        num_workers=0,
    )
    ...
    cv2.imwrite(current_dir+'/temp-img-disp/display.jpg',resized) 
    img = cv2.imread(current_dir+'/temp-img-disp/display.jpg')
